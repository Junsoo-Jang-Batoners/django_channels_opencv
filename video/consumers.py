...
class VideoConsumer(AsyncWebsocketConsumer):
    ...
    async def receive(self, text_data):
        ...
        if text_data[0] == '"' and text_data[-1] == '"':
            text_data = text_data[1:-1]
        base64data = text_data[22:]
        ...
        if quit_cnt >= 30 and flag:
            ...
            infdata['name'] = self.scope['user'].username + '_' + str(filenamenumber) + '.inference'
            infdata['gloss'] = ''
            infdata['text'] = ''
            infdata['signer'] = self.scope['user'].username
            infdata['sign'] = sign
