...
def beam_search(
    ...
    for step in range(max_output_length):
        ...
        # print(f'type of topk_beam_index: {type(topk_beam_index)}')
        # print(f'topk_beam_index: {topk_beam_index}')
        # print(f'topk_beam_index_true: {topk_ids.true_divide(decoder.output_size)}')
        ...
        # print(f'beam_offset: {beam_offset[: topk_beam_index.size(0)].unsqueeze(1)}')
        # print(f'type of batch_index: {type(batch_index)}')
